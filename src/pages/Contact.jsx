...
function Contact() {
  return (
    ...
    <>
    <SEO
      title="Contact Ultimate Health Men | Winter Haven Men's Health Clinic"
      ...
      canonical="https://ultimatehealthmen.com/contact"
    />
      ...
      <section className="mx-auto max-w-7xl px-6 py-20">
        <div className="max-w-4xl">
          ...
          <p className="mt-6 max-w-3xl text-lg leading-8 text-[var(--text-muted)] sm:text-xl">
            Have a question, want to learn more, or ready to schedule? Reach out
            to Ultimate Health Men and take the next step toward direct,
            personalized care.
          </p>
