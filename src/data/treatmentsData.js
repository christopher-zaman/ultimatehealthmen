...
export const treatments = [
  ...
  },
  {
    ...
    price: "$150/week",
    benefits: [
      "Advanced weight loss support",
      "Helps regulate appetite",
      "Supports glucose control",
      "May support long-term metabolic health",
    ],
  },
  {
  ...
  },
  {
    ...
    benefits: [
      ...
      "Dispensed directly from the office when appropriate",
    ],
  },
  {
    ...
    benefits: [
      ...
      "Personalized based on lab results",
      "Options may include pellets, creams, or injections",
    ],
  },
  {
    slug: "pt-141",
    ...
    benefits: [
      "Supports libido",
      "May help with arousal",
      "May support confidence and intimacy",
      "Works differently than traditional ED medications",
    ],
  },
  {
    slug: "bpc-157",
    ...
    benefits: [
      ...
      "May help with joint or workout recovery",
    ],
  },
  {
    slug: "tesamorelin",
    ...
    benefits: [
      "Supports fat loss",
      "Stimulates natural growth hormone pathways",
      "May support sleep and energy",
  ...
  },
  {
    ...
    benefits: [
      ...
      "Supports metabolism",
      "May support vitality and healthy aging",
    ],
  },
  {
    slug: "ipamorelin",
  ...
  },
  {
    ...
    benefits: [
      "Fast acting",
      "Reliable option for ED",
      "Personalized dosing",
      "May support stronger, longer-lasting results",
    ],
  },
  {
    ...
    benefits: [
      ...
      "Includes common options such as Viagra, Cialis, and Levitra",
    ],
  },
  {
    ...
    benefits: [
      ...
      "Supports energy",
      "May support immunity and recovery",
    ],
  },
  {
